...
{{< highlight bash >}}make menuconfig{{< /highlight >}}
<br/>
...
{{< highlight vim "linenos=inline,hl_lines=29 30" >}}  [*] DMA memory allocation support
  ...
  Memory model (Sparse Memory)  --->{{< /highlight >}}
<br/>
<hr/>
...
{{< highlight bash >}}emerge --ask --update --newuse sys-firmware/intel-microcode{{< /highlight >}}
<br/>
Void Linux:

{{< highlight bash >}}xbps-install -S intel-ucode{{< /highlight >}}
<br/>
Arch Linux:

{{< highlight bash >}}pacman -Syu intel-ucode{{< /highlight >}}
<br/>
...
{{< highlight bash >}}ls -l /lib/firmware{{< /highlight >}}
{{< highlight bash >}}drwxr-xr-x 2 root root 4096 Apr 13 21:47 intel-ucode{{< /highlight >}}
<br/>
Alright, looks like a new folder <mark>intel-ucode</mark> was created. Let's see if it had the microcode update files:
{{< highlight bash >}}ls -l /lib/firmware/intel-ucode{{< /highlight >}}
{{< highlight bash >}}06-03-02  06-06-05  06-08-01  06-0a-01	06-0f-02  06-16-01  06-1c-02  06-26-01	06-3c-03  06-3f-04  06-56-02  0f-01-02	0f-03-02  0f-04-07  0f-06-05
...
06-06-00  06-07-03  06-0a-00  06-0e-0c	06-0f-0d  06-1a-05  06-25-05  06-3a-09	06-3f-02  06-4f-01  0f-00-0a  0f-02-09	0f-04-04  0f-06-04{{< /highlight >}}
<br/>
...
{{< highlight bash >}}emerge -av sys-apps/iucode_tool{{< /highlight >}}
<br/>
...
<br/>
Now run this:
{{< highlight bash >}}iucode_tool -S{{< /highlight >}}
{{< highlight bash "linenos=inline,hl_lines=1" >}}iucode_tool: system has processor(s) with signature 0x000306c3{{< /highlight >}}
<br/>
...
{{< highlight bash >}}emerge -av sys-apps/cpuid{{< /highlight >}}
<br/>
...
<br/>
Now run:
{{< highlight bash >}}cpuid | grep "processor serial number"{{< /highlight >}}
 {{< highlight properties "linenos=inline,hl_lines=2 4 6 8 10 12 14 16" >}}      processor serial number                = false
...
{{< highlight bash >}}emerge --ask --update --newuse sys-apps/dmidecode{{< /highlight >}}
<br/>
Void Linux:

{{< highlight bash >}}xbps-install -S dmidecode{{< /highlight >}}
<br/>
Arch Linux:

{{< highlight bash >}}pacman -Syu dmidecode{{< /highlight >}}
<br/>
Now run:
{{< highlight bash >}}dmidecode | grep -w ID{{< /highlight >}}
{{< highlight vim "linenos=inline,hl_lines=6" >}}	ID: 0
	ID: 1
	ID: 2
	ID: 3
	ID: 4
	ID: C3 06 03 00 FF FB EB BF{{< /highlight >}}
<br/>
...
{{< highlight bash >}}iucode_tool -L /lib/firmware/intel-ucode | grep 0x000306c3 -B 1{{< /highlight >}}
{{< highlight bash "linenos=inline,hl_lines=1" >}}microcode bundle 26: /lib/firmware/intel-ucode/06-3c-03
...
{{< highlight vim "linenos=inline,hl_lines=8 9" >}}  [ ] Support for uevent helper
  ...
  [ ] Enable verbose DMA_FENCE_TRACE messages{{< /highlight >}}
<br/>
Change:
<br/>
<br/>
...
{{< highlight bash >}}dmesg | grep microcode{{< /highlight >}}
{{< highlight vim "linenos=inline,hl_lines=1" >}}[    0.795219] microcode: sig=0x306c3, pf=0x10, revision=0x22
[    0.795433] microcode: Microcode Update Driver: v2.01 <tigran@aivazian.fsnet.co.uk>, Peter Oruba{{< /highlight >}}
<br/>
